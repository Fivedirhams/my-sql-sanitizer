"""Company transformer — company name replacements via LLM."""
...
class CompanyTransformer(BaseTransformer):
    """Replace company names with realistic alternatives.
    ...
    def transform(self, value: Optional[str], table: str, column: str) -> Optional[str]:
        ...
        # Fallback: cycle within observed companies
        ...
        return value  # Preserve original rather than fake
    ...
    def _load_mapping(
        ...
        if unseen:
            result = client.generate_company_mapping(field_key, unseen)
